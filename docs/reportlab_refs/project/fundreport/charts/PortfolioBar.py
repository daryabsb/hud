...
from reportlab.lib.colors import red, blue, white, darkblue, aquamarine, cadetblue, cyan, darkcyan, deepskyblue, mediumslateblue, midnightblue, navy, royalblue, fidlightblue, teal, grey, toColor, Color, gray
...
class PortfolioBar(_DrawingEditorMixin,Drawing):
    def __init__(self,width=400,height=200,*args,**kw):
        ...
        self.legend.colorNamePairs   = [(Rect(0,0,0,0,strokeColor=toColor(0x1f497d),fillColor=toColor(0x1f497d),strokeWidth=0.5), 'Profit / Loss'), (Rect(0,0,0,0,strokeColor=toColor('gray'),fillColor=toColor('gray'),strokeWidth=0.5), 'Limit'), (Rect(0,0,0,0,strokeColor=toColor('red'),fillColor=None,strokeWidth=0.5), 'Stop Loss')]
        self.legend.x                = 20
        ...
        self.chart.categoryAxis.categoryNames        = ['Short Quasi-sov resources']+['label'] * 11
        ...
        self.chart.bars[1].symbol.fillColorStart = gray
        self.chart.bars[1].symbol.fillColorEnd = white
        self.chart.bars[0].symbol      = ShadedRect()
        self.chart.bars[0].symbol.fillColorStart = Color(.121569,.286275,.490196,1)
        self.chart.bars[0].symbol.fillColorEnd = white
        self.legend.fontName         = 'Helvetica'
        self.chart.valueAxis.labels.fontName          = 'Helvetica'
        self.chart.valueAxis.labels.fontSize          = 6
        self.chart.categoryAxis.labels.dx               = -2
        self.chart.bars[0].symbol.strokeWidth    = 0.5
        self.chart.bars[0].symbol.strokeColor    = self.chart.bars[0].symbol.fillColorStart
        self.chart.bars[1].symbol.strokeWidth    = 0.5
        self.chart.bars[1].symbol.strokeColor    = self.chart.bars[1].symbol.fillColorStart
