...
APP_TABLES_COLUMNS = [
    ...
    {"id": 13, "app": "products", "name": "currency", "title": "Currency",
        "is_enabled": True, "is_related": True, "related_value": "currency__name", "searchable": True, },
    ...
    {"id": 20, "app": "products", "name": "is_price_change_allowed",
        "title": "Is Price Change Allowed", "is_enabled": True, "is_related": False, "related_value": "", "searchable": True, },
    {"id": 21, "app": "products", "name": "is_service", "title": "Is Service",
        "is_enabled": True, "is_related": False, "related_value": "", "searchable": True, },
    {"id": 22, "app": "products", "name": "is_using_default_quantity",
        "title": "Is Using Default Quantity", "is_enabled": True, "is_related": False, "related_value": "", "searchable": True, },
    {"id": 23, "app": "products", "name": "is_product", "title": "Is Product",
        "is_enabled": False, "is_related": False, "related_value": "", "searchable": True, },
    ...
    {"id": 31, "app": "documents", "name": "cash_register", "title": "Cash Register",
        "is_enabled": True, "is_related": True, "related_value": "cash_register__name", "searchable": True, },
    ...
    {"id": 34, "app": "documents", "name": "warehouse", "title": "Warehouse",
        "is_enabled": True, "is_related": True, "related_value": "warehouse__name", "searchable": True, },
